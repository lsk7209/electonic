...
export const metadata: Metadata = pageMetadata({
  title: "Privacy policy for WattBench",
  description: "WattBench privacy policy covering electric bill estimator inputs, cookies, AdSense, consent, and analytics.",
  path: "/privacy"
});
  ...
  return (
    <main className="section">
      <div className="reading prose">
        <h1>Privacy policy for WattBench</h1>
        ...
        <p>WattBench does not sell electricity plans, collect utility account numbers, or ask visitors to submit personal billing details through the estimator.</p>
      </div>
    </main>
  );
}
