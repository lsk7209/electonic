    ...
    <main>
      ...
      <section className="section">
        <div className="reading prose">
          ...
          <p>Our state-rate ingestion reads the EIA electricity retail-sales API with the residential sector filter and records the reporting period with every stored value. Readers can inspect the public EIA electricity data catalog and the API endpoint used for the monthly rate context.</p>
          <ul>
